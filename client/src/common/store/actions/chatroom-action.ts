import { LOAD_ASYNC, INIT_SIDEBAR_ASYNC, PICK_CHANNEL_ASYNC, INSERT_MESSAGE, ADD_CHANNEL } from '../types/chatroom-types';
...
export const addChannel = (payload: any) => ({ type: ADD_CHANNEL, payload });
